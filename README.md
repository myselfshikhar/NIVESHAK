...
Welcome to **NIVESHAK **! This repository includes a  of the popular stock trading platform, built using the MERN stack.
...
**Description**: A popular stock trading platform, NIVESHAK, built using the MERN stack.
...
- [Demo](https://niveshak-frontend-aaq49q9us-shikhars-projects-b83a3980.vercel.app/)
- UserName : Demo
- Password : Demo
...
### Enjoy exploring and contributing to NIVESHAK!
